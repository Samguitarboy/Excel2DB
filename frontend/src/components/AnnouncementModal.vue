  ...
  <div class="modal-backdrop">
    <div class="modal-content shadow">
      ...
      <div class="announcement-body" @scroll="handleScroll" ref="announcementBody">
        <p><strong>最後更新日期：2025年8月18日</strong></p>
        ...
        <p class="important"><strong>原則上，行政單位各組配置一支隨身碟，工廠各股與廠長室亦同。</strong></p><p>惟有特殊需求，須於申請單上敘明理由，經資訊室評估後予以發放。<br>倘若單位主管評估無需使用隨身碟，則單位管控窗口免填申請單。<br>連續一個月以上無使用紀錄者，資訊室會提醒填寫歸還單，<br>建議有需求時再向資訊室登記借用。<br>★ 預計汰換時程：<br>Now - 20250829：<br>統計各單位新款加密隨身碟申請數量。(請各單位窗口線上申請)<br>202509 - 202511：<br>請各單位窗口攜帶「已簽准之申請單」及「單位舊款隨身碟」<br>至兩廠資訊室做汰換程序。(後續會以Mail或電話通知窗口)  <br><br>(內部電腦間傳輸資料，請優先考慮廠內「公務網路儲存空間」)</p>        
        <h5><br>二、使用者責任</h5>
