  ...
  <div class="modal-backdrop">
    <div class="modal-content shadow">
      ...
      <div class="announcement-body" @scroll="handleScroll" ref="announcementBody">
        <p><strong>最後更新日期：2025年8月29日</strong></p>
        ...
        <h5><br>一、發放規則 (新款加密公務用隨身碟)</h5>
        <p class="important"><strong>原則上，行政單位各組配置一支隨身碟，工廠各股與廠長室亦同。</strong></p><p>惟有特殊需求，須於申請單上敘明理由，經資訊室評估後予以發放。<br>倘若單位主管評估無需使用隨身碟，則單位管控窗口免填申請單。<br>連續一個月以上無使用紀錄者，資訊室會提醒填寫歸還單，<br>建議有需求時再向資訊室登記借用。<br><br>★ 預計汰換時程：<br>20250901 - 20250919：<br>資訊室線上核准申請後，會通知各單位窗口至系統下載申請單。<br>請窗口將申請單送交單位主管核章(行政單位至主任、工廠至廠長)，<br>再把「已簽核之申請單」回傳資訊室。<br>20250922 - 202511：<br>後續資訊室會以Mail或電話通知單位窗口，<br>再請窗口派人拿「單位舊款隨身碟」至兩廠資訊室做汰換程序。  <br><br>(內部電腦間傳輸資料，請優先考慮廠內「公務網路儲存空間」)</p>        
        <h5><br>二、使用者責任</h5>
